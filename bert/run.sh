...
echo "gpu-4 done"
rm -rf output/
python run_pretraining.py --mode=data_parallel --bert_config_file=./bert_config.json --input_train_files=/data/DNN_Dataset/zhwiki/tfdir/ --output_dir=./output --gpu_num=8 &> 8.log
echo "gpu-4 done"
rm -rf output/